...
export function ChannelStrip({
  ...
  return (
    <ChannelStripPrimitive.Root
      className={cn(
        "group/channel-strip mx-auto inline-flex rounded-4xl bg-card p-4 text-card-foreground shadow-md ring-1 ring-foreground/5 dark:ring-foreground/10",
...
export function ChannelStripHeader({
  ...
  return (
    <ChannelStripPrimitive.Header
      className={cn(
        "w-full text-center font-heading font-medium text-sm",

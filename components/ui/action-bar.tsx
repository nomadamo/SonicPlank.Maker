...
export interface ActionBarProps extends Pick<
...
interface ActionBarTriggerProps extends React.ComponentProps<
  typeof ark.button
> {}

const ActionBarTrigger = (props: ActionBarTriggerProps) => {
...
const actionBarPositionerVariants = tv({
  ...
  variants: {
    placement: {
      bottom:
        "flex fixed justify-self-center inset-x-0 bottom-0 px-4 pb-[calc(var(--gutter)+env(safe-area-inset-bottom,0))]",
      "bottom-end":
        "justify-self-end flex fixed inset-x-0 bottom-0 px-4 pb-[calc(var(--gutter)+env(safe-area-inset-bottom,0))]",
      "bottom-start":
        "justify-self-start flex fixed inset-x-0 bottom-0 px-4 pb-[calc(var(--gutter)+env(safe-area-inset-bottom,0))]",
      "float-top": "absolute [position-area:top_center] mb-5",
      "float-bottom": "absolute [position-area:bottom_center] mt-5",
    },
  },
  defaultVariants: {
    placement: "bottom",
...
export interface ActionBarContentProps extends React.ComponentProps<
  typeof ark.div
> {}
...
export interface ActionBarSeparatorProps extends React.ComponentProps<
  typeof Separator
> {}
...
interface ActionBarCloseProps extends React.ComponentProps<typeof ark.button> {}

const ActionBarClose = (props: ActionBarCloseProps) => {
...
export interface ActionBarValueProps extends React.ComponentProps<
  typeof Badge
> {
  /**
